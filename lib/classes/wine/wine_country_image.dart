...
class CountryIcons {
  static final List<CountryImage> images = [
    ...
    CountryImage(country: 'Switzerland', imagePath: 'assets/images/switzerland.png'),
    ...
    CountryImage(country: 'Australia', imagePath: 'assets/images/australia.png'),
    CountryImage(country: 'Portugal', imagePath: 'assets/images/portugal.png'),
    CountryImage(country: 'Argentina', imagePath: 'assets/images/argentina.png'),
    ...
    CountryImage(country: 'South Africa', imagePath: 'assets/images/south_africa.png'),
    CountryImage(country: 'New Zealand', imagePath: 'assets/images/new_zealand.png'),
  ];
  ...
  static Widget getImageForCountry(String country, {double size = 50}) {
    final imagePath = images
        .firstWhere(
          ...
          orElse: () => CountryImage(country: 'default', imagePath: defaultImagePath),
        )
        .imagePath;
  ...
  static const String defaultImagePath = 'assets/images/default.png'; // Default image if country not found
}
